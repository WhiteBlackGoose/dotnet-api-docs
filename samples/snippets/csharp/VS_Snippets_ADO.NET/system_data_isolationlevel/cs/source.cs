...
namespace CSDataIsolationLevel {
   ...
   public delegate void AsyncAccessDatabase(stringconnString, IsolationLevel level);

   static class DirtyReadThreads {
      public static void DirtyReadFirstThread(stringconnStrig, IsolationLevel level) {
         Console.WriteLine("Begin the DirtyReadFirstThread.....");

         using (SqlConnection conn = new SqlConnection(connStrig)) {
            stringcmdText = @"Use DbDataIsolationLevel;
      ...
      public static void DirtyReadSecondThread(stringconnStrig, IsolationLevel level) {
   ...
   static class NonrepeatableReadThreads {
      public static void NonrepeatableReadFirstThread(stringconnStrig, IsolationLevel level) {
      ...
      public static void NonrepeatableReadSecondThread(stringconnStrig, IsolationLevel level) {
   ...
   static class PhantomReadThreads {
      public static void PhantomReadFirstThread(stringconnStrig, IsolationLevel level) {
      ...
      public static void PhantomReadSecondThread(stringconnStrig, IsolationLevel level) {
   ...
   static class TransactionIsolationLevels {
      public static void DemonstrateIsolationLevel(stringconnString, IsolationLevel level) {
      ...
      static class ExchangeValuesThreads {
         public static void ExchangeValuesFirstThread(stringconnStrig, IsolationLevel level) {
         ...
         public static void ExchangeValuesSecondThread(stringconnStrig, IsolationLevel level) {
      ...
      public static void DemonstrateBetweenSnapshotAndSerializable(stringconnString) {
         OperateDatabase.CreateTable(connString);
      ...
      public static void DisplayData(stringconnString) {
   ...
   static class OperateDatabase {
      public static Boolean CreateDatabase(stringconnString) {
         using (SqlConnection conn = new SqlConnection(connString)) {
            stringcmdText = @"Use Master;
      ...
      public static Boolean CreateTable(stringconnString) {
         using (SqlConnection conn = new SqlConnection(connString)) {
            stringcmdText = @"Use DbDataIsolationLevel
      ...
      public static Boolean InsertRows(stringconnString) {
         using (SqlConnection conn = new SqlConnection(connString)) {
            stringcmdText = @"Use DbDataIsolationLevel
      ...
      public static Boolean SetSnapshot(stringconnString, Boolean isOpen) {
         using (SqlConnection conn = new SqlConnection(connString)) {
            stringcmdText = null;
   ...
   class Program {
      static void Main(string[] args) {
         stringconnString = "Data Source=(local);Initial Catalog=master;Integrated Security=True;Asynchronous Processing=true;";
